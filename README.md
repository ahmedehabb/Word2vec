...
- Based on the Word2Vec papers by Mikolov et al.
- Uses the text8 dataset via Hugging Face
- Inspired by Chris McCormick's Word2Vec tutorial

---

**Made with ❤️ for learning and understanding word embeddings**
